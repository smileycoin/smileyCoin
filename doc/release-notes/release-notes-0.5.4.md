Auroracoin version 0.5.4 is now available for download at:
...
http://gitorious.org/auroracoin/auroracoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Auroracoin-Qt notifications under Growl 1.3.
Increase required age of Auroracoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAuroracoin properly when installing Auroracoin-Qt over it. (Windows)
