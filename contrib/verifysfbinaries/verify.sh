...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'auroracoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[auroracoin-]<version>-[rc[0-9]] (example: auroracoin-0.7.1-rc1)"
   echo "wget output:"
