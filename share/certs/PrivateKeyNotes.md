...
unlocked to sign the Auroracoin-Qt.app bundle.
...
allowing somebody to distribute a Auroracoin-Qt.app or auroracoin-qt-setup.exe with a valid
...
that the auroracoin-qt.exe file inside the installer had not been tampered with.
