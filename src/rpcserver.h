...
extern json_spirit::Value riddleMeThis(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value riddleMeThisAnswer(const json_spirit::Array& params, bool fHelp);
