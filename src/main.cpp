...
{
    // Smileycoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Smileycoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Smileycoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x660f734cf6c6d16111bde201bbd2122873f2f2c078b969779b9d4c99732354fd");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        // Fix timestamp when epoch time is updated, need something from same day (19/Aug/2014).
        ...
        block.nVersion = 1;
        block.nTime    = 1408974288;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 386703170;
        ...
        assert(block.hashMerkleRoot == uint256("0xe9441ec39c399c76ea734ea31827e1895a82c5a1f9b2c6252b5dacada768ec8b"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Smileycoin: increase each by adding 2 to bitcoin's value.
...
void static SmileycoinMiner(CWallet *pwallet)
{
    printf("SmileycoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("smileycoin-miner");
    ...
    try { loop {
        ...
        printf("Running SmileycoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("SmileycoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&SmileycoinMiner, pwallet));
}
