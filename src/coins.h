...
public:
    ...
    //Retrieve the balance of and height where a given scriptPubKey was last used.
    virtual bool GetServiceInfo(const CScript &key, std::pair<std::string, std::string> &value);

    //Modify the balance of and height where a given scriptPubKey was last used.
    virtual bool SetServiceInfo(const CScript &key, const std::pair<std::string, std::string> &value);
...
protected:
    ...
    std::map<CScript, std::pair<std::string, std::string> > cacheServiceInfo;
